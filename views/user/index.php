...
$this->title = Yii::t('yiiplus/desktop', '用户管理');
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model) {
                    return $model->status == 0 ? Yii::t('yiiplus/desktop', '禁用') : Yii::t('yiiplus/desktop', 'Activate');
                },
                'filter' => [
                ...
                'buttons' => [
                    'assignment' => function($url, $model) {
                        $options = [
                            ...
                            'aria-label' => Yii::t('yiiplus/desktop', '分配'),
                            'data-method' => 'post',
                            'data-pjax' => '0',
                        ];
                    ...
                    'activate' => function($url, $model) {
                        ...
                        $options = [
                            ...
                            'aria-label' => Yii::t('yiiplus/desktop', '启用'),
                            'data-confirm' => Yii::t('yiiplus/desktop', '确实要激活此用户吗?'),
                            'data-method' => 'post',
                            'data-pjax' => '0',
                        ];
                    ...
                    'inactive' => function($url, $model) {
                        ...
                        $options = [
                            ...
                            'data-confirm' => Yii::t('yiiplus/desktop', '确实要将此用户禁用？'),
                            'data-method' => 'post',
                            'data-pjax' => '0',
                        ];
